...
import { FilterOperationsEnum, IAppliedFilter, IPagination, ISortState, ITableHeader, ITableHeaderOptions, ITableItemSearchState, ITableProps, ITableRows } from "./Interface";
import { FiterPopover, TableItemSearch } from "./Components";
import Pagination from "./Components/Pagination";

const TableBack: FC<ITableProps> = ({ tableHeader: initialTableHeader, tableRows: initialTableRows, initalSort, rowInPage }) => {
    ...
    useEffect(() => {
        const offset = handlePaginate(tableRows, pagination);
        setOffSet(() => offset);
    ...
    const handleSortfn = async (key: string) => {
        ...
        result.tableRows && setTableRows(result.tableRows);
    };
    ...
    return (
        <div className={Styles.TableContainer}>
            <TableItemSearch
                ...
                hendleItemSearch={(searchVal: string) => {
            ...
            <UITable className={Styles.UITable}>
                ...
                <Tbody className={Styles.Tbody}>
                    {tableRows.map((row: ITableRows, idx: number) => (
