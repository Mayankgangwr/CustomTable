...
import { FilterOperationsEnum, IFilterOperations, IFiterPopoverProps, ITableHeaderOptions } from "../Interface";
import { FC, useEffect, useState } from "react";
import { FilterOperations } from "../Utils";
import Styles from "../Table.module.scss";
import DatePopverContent from "./DatePopverContent";

const FiterPopoverContent: FC<IFiterPopoverProps> = ({
  column,
  handleFilter,
  options = undefined,
  dataType = 'string',
...
const FiterPopover: FC<IFiterPopoverProps> = ({
  column,
  handleFilter,
  options = undefined,
  dataType = "string",
